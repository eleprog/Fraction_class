...
////////////////////* *////////////////////
// 1) если второй аргумент имеет нулевую ссылку то имеем ли мы право записать туда дефолтную дробь
// 2) на основе какого аргумента мы должны принимать решение о сокращении дроби (может имеет смысл пользоваться конструкцией drobc.addition(drobA, drobB))
// 3) при записи результата арифметического действия откуда брать значение localReductionFlag и нужно ли его записывать?
